...
the parser purposesly does not use the APIs for segment or anything else if I create then later,
its assumed that the parser understands the internals of all the different elements
