...
TcpServer.prototype.createAckMessage = function(msg) {
  var now = new Date();
  var ack = new Message(
                        msg.header.getHeaderField(5),
                        msg.header.getHeaderField(6),
                        msg.header.getHeaderField(3),
                        msg.header.getHeaderField(4),
                        this.getDate(now),
                        '',
                        ["ACK"],
                        this.getControlId(now),
                        msg.header.getHeaderField(11),
                        msg.header.getHeaderField(12))
